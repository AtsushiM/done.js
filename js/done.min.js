/* done.js v0.1 (c) 2013 Atsushi Mizoue. */!function(){var f=!0,g=!1,h,l,m,n,p,q,r,s,t,u,v,w,x,y,z,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P={}.hasOwnProperty;L="undefined"===typeof module?window:module.exports;m={};x=g;w=/0/.test(function(){0})?/\b_super\b/:/.*/;l=function(){};O=function(a,b){return Object.prototype.toString.call(b)==="[object "+a+"]"?f:g};J=function(a){return O("Number",a)};K=function(a){return O("String",a)};G=function(a){return O("Array",a)};I=function(a){return O("Function",a)};H=function(a){return void 0===a?g:f};
M=function(a,b){return function(){return b.apply(a,arguments)}};N=function(a){var b;b=[];b.push.apply(b,a);return b};y=function(a){return G(a)?a.slice(0):a};z=function(a,b){a.splice(b,1)};u=function(a,b){var c,d,e;for(c in b)if(e=b[c],d=c.match(/^on(.+)$/))a.on(d[1],e)};F=function(a){return!(!I(a)||!a.length)};B=function(a){a.emit("complete")};C=function(a){a.emit("nexttask")};E=function(a){a.emit("start")};D=function(a){a.emit("progress")};
l.extend=function(a){var b,c,d;b=this;l=function(){!x&&this.init&&this.init.apply(this,arguments)};c=function(c){var d,k;d=a[c];k=b.prototype[c];I(d)&&I(k)&&w.test(d)?l.prototype[c]=function(){var a,b;b=this._super;this._super=k;a=d.apply(this,arguments);this._super=b;return a}:l.prototype[c]=d};x=f;l.prototype=new b;x=g;l.prototype.constructor=l;for(d in a)P.call(a,d)&&c(d);l.extend=b.extend;return l};v=function(a,b,c){a=a||l;a=a.extend(b);H(c)&&(a.support=c);return a};
s=function(a,b){delete a[b].b;z(a,b)};p=function(){var a,b;a=N(arguments||[]);b=this.only.apply(this,a);if(g!==b&&!(b||{}).h)(b=this.b)&&b.bubble.apply(b,a)};r=function(){return this.g=f};t=function(){return this.h=f};q=function(a,b){var c;c=b[0];K(c)&&(c={type:c,arguments:b,g:g,h:g,preventDefault:r,stopPropagation:t});c.before=c.target;c.target=a;return c};
